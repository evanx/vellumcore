...
public class Lists {
    ...
    public static <T extends C, C> LinkedList<T> sortedLinkedList(Collection<T> collection, 
    ...
    public static <T extends C, C> LinkedList<T> sortedReverseLinkedList(Collection<T> collection, 
            Comparator<C> comparator) {
